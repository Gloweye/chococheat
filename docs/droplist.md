...
I'm still researching what exactly makes the game choose either drop table. I could have sword I saw a difference after
making Tonberry forget Familiar with Amnesia Greens, but I can't seem to reproduce it. The 
[only guide](https://gamefaqs.gamespot.com/ps/197343-final-fantasy-viii/faqs/4929) on the internet
referencing this multiple tables claims it has to do with ID and level.
